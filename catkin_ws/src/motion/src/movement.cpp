...
void taskCommanderCallback(const motion::legoTask::ConstPtr &msg_taskCommand) {
        ...
        if (msg_taskCommand->command_id == no_command) { 
                ...
                cout << endl;
                cout << "receved a message without commands!!" << endl;
                cout << endl;
                return;
        }
        ...
        switch (task_command.command_id) {
                ...
                case(command_test):     cout << "execution of null / test command..." << endl;
                                        nullCommandExecute();
                                        cout << "null / test command terminated" << endl;                                                                                    
                                        break;

                case(command_wait):     cout << "execution of wait command..." << endl;
                                        waitCommandExecute(task_command.w_time);
                                        cout << "Wait command terminated" << endl;
                                        break;

                case(command_move):     cout << "execution of move command..." << endl;
                                        ...
                                        cout << "Move command terminated" << endl;
                                        break;

                case(command_grasp):    cout << "execution of grasp command..." << endl;
                                        graspObject(true);
                                        cout << "Grasp command terminated" << endl;
                                        break;

                case(command_ungrasp):  cout << "execution of ungrasp command..." << endl;
                                        graspObject(false);
                                        cout << "Ungrasp command terminated" << endl;
                                        break;             

                case(command_def_pos):  cout << "execution of move to default position command..." << endl;
                                        moveDefaultPosition();
                                        cout << "Move default position command terminated" << endl;
                                        break;                                                                  

                case(command_fast_catch):       cout << "execution of fast catch command..." << endl;
                                                fastCatchProcedure();
                                                cout << "Fast catch command terminated" << endl;
                                                break;                                                  

                case(command_catch):    cout << "execution of catch command..." << endl;
                                        catchProcedure();
                                        cout << "Catch command terminated" << endl;
                                        break;                                                                           

                default:                cout << "Unsupported command receved!" << endl;
                                        break;
        }
...
void fastCatchProcedure() {
        ...
        Eigen::Vector3f position2move;
        Eigen::Vector3f v_orientation;
        cout << "Starting fast catch procedure..." << endl;
