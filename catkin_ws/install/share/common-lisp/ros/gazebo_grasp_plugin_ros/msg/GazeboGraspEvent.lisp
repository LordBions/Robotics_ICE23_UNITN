...
(cl:in-package gazebo_grasp_plugin_ros-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <GazeboGraspEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GazeboGraspEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_grasp_plugin_ros-msg:<GazeboGraspEvent> is deprecated: use gazebo_grasp_plugin_ros-msg:GazeboGraspEvent instead.")))

(cl:ensure-generic-function 'arm-val :lambda-list '(m))
(cl:defmethod arm-val ((m <GazeboGraspEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_grasp_plugin_ros-msg:arm-val is deprecated.  Use gazebo_grasp_plugin_ros-msg:arm instead.")
  (arm m))

(cl:ensure-generic-function 'object-val :lambda-list '(m))
(cl:defmethod object-val ((m <GazeboGraspEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_grasp_plugin_ros-msg:object-val is deprecated.  Use gazebo_grasp_plugin_ros-msg:object instead.")
  (object m))

(cl:ensure-generic-function 'attached-val :lambda-list '(m))
(cl:defmethod attached-val ((m <GazeboGraspEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_grasp_plugin_ros-msg:attached-val is deprecated.  Use gazebo_grasp_plugin_ros-msg:attached instead.")
  (attached m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GazeboGraspEvent>)))
  ...
  "gazebo_grasp_plugin_ros/GazeboGraspEvent")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GazeboGraspEvent)))
  "Returns string type for a message object of type 'GazeboGraspEvent"
  "gazebo_grasp_plugin_ros/GazeboGraspEvent")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GazeboGraspEvent>)))
  ...
  (cl:format cl:nil "# Message to notify about grasp events in gazebo~%~%# name of grasping arm/gripper ~%string arm~%~%# collision shape name of grasped object~%string object~%~%# detached if false~%bool attached~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GazeboGraspEvent)))
  "Returns full string definition for message of type 'GazeboGraspEvent"
  (cl:format cl:nil "# Message to notify about grasp events in gazebo~%~%# name of grasping arm/gripper ~%string arm~%~%# collision shape name of grasped object~%string object~%~%# detached if false~%bool attached~%~%~%"))
