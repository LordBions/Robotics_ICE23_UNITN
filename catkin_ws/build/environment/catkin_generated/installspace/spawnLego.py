...
path = rospkg.RosPack().get_path("ros_impedance_controller")
...
def getLego4Build(select=None):
	...
	rospy.init_node("ros_impedance_controller")
...
#DEFAULT PARAMETERS
package_name = "ros_impedance_controller"
spawn_name = '_spawn'
level = None
selectBrick = None
maxLego = 8
...
if __name__ == '__main__':
	...
	try:
		...
		print(f"Check model in folder'{package_name}/worlds/models'")
		pass
