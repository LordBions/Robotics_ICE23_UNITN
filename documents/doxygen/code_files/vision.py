...
## Subscriver to Zed Camera pointcloud
...
def subReceiveImage(data):
    ...
    @param data     msg taken from ZED node
    """
...
def pointCloudCallBack(msg):
    ...
    @param msg  msg taken from ZED camera
    """
    global allow_receive_image
    global allow_receive_pointcloud
    global vision_ready
...
def detectResulterCallback(ack_ready):
    ...
    @param ack_ready    msg received by Planner
    """
    global allow_receive_image
    global allow_receive_pointcloud
    global vision_ready
