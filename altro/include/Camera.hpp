...
namespace sl {
    ...
    enum class ERROR_CODE {
        ...
        NOT_ENOUGH_GPU_MEMORY = 3, /**< Not enough GPU memory for this depth mode, try a different mode (such as PERFORMANCE), or increase the minimum depth value (see InitParameters::depth_minimum_distance).*/
        CAMERA_NOT_DETECTED = 4, /**< The ZED camera is not plugged or detected.*/
        SENSORS_NOT_INITIALIZED = 5, /**< The MCU that controls the sensors module has an invalid Serial Number. You can try to recover it launching the 'ZED Diagnostic' tool from the command line with the option '-r'.*/
        SENSORS_NOT_AVAILABLE = 6, /**< a ZED-M or ZED2/2i camera is detected but the sensors (imu,barometer...) cannot be opened. Only for ZED-M or ZED2/2i devices. Unplug/replug is required*/
        INVALID_RESOLUTION = 7, /**< In case of invalid resolution parameter, such as a upsize beyond the original image size in Camera::retrieveImage */
        LOW_USB_BANDWIDTH = 8, /**< This issue can occurs when you use multiple ZED or a USB 2.0 port (bandwidth issue).*/
        CALIBRATION_FILE_NOT_AVAILABLE = 9, /**< ZED calibration file is not found on the host machine. Use ZED Explorer or ZED Calibration to get one.*/
        INVALID_CALIBRATION_FILE = 10, /**< ZED calibration file is not valid, try to download the factory one or recalibrate your camera using 'ZED Calibration'.*/
        INVALID_SVO_FILE = 11, /**< The provided SVO file is not valid.*/
        SVO_RECORDING_ERROR = 12, /**< An recorder related error occurred (not enough free storage, invalid file).*/
        SVO_UNSUPPORTED_COMPRESSION = 13, /**< An SVO related error when NVIDIA based compression cannot be loaded.*/
        END_OF_SVOFILE_REACHED = 14, /**<SVO end of file has been reached, and no frame will be available until the SVO position is reset.*/
        INVALID_COORDINATE_SYSTEM = 15, /**< The requested coordinate system is not available.*/
        INVALID_FIRMWARE = 16, /**< The firmware of the ZED is out of date. Update to the latest version.*/
        INVALID_FUNCTION_PARAMETERS = 17, /**< An invalid parameter has been set for the function. */
        CUDA_ERROR = 18, /**< In grab() or retrieveXXX() only, a CUDA error has been detected in the process. Activate verbose in sl::Camera::open for more info.*/
        CAMERA_NOT_INITIALIZED = 19, /**< In grab() only, ZED SDK is not initialized. Probably a missing call to sl::Camera::open.*/
        NVIDIA_DRIVER_OUT_OF_DATE = 20, /**< Your NVIDIA driver is too old and not compatible with your current CUDA version. */
        INVALID_FUNCTION_CALL = 21, /**< The call of the function is not valid in the current context. Could be a missing call of sl::Camera::open. */
        CORRUPTED_SDK_INSTALLATION = 22, /**< The SDK wasn't able to load its dependencies or somes assets are missing, reinstall the ZED or check for missing dependencies (cudnn, TensorRt). */
        INCOMPATIBLE_SDK_VERSION = 23, /**< The installed SDK is incompatible SDK used to compile the program. */
        INVALID_AREA_FILE = 24, /**< The given area file does not exist, check the path. */
        INCOMPATIBLE_AREA_FILE = 25, /**< The area file does not contain enought data to be used or the sl::DEPTH_MODE used during the creation of the area file is different from the one currently set. */
        ...
        CAMERA_DETECTION_ISSUE = 27, /**< Your ZED can not be opened, try replugging it to another USB port or flipping the USB-C connector.*/
        CANNOT_START_CAMERA_STREAM = 28, /**< Cannot start camera stream. Make sure your camera is not already used by another process or blocked by firewall or antivirus.*/
        ...
        MODULE_NOT_COMPATIBLE_WITH_CAMERA = 31, /**< The Object detection module is only compatible with the ZED 2*/
   ...
   \brief Properties of a streaming device
    ...
    enum class BUS_TYPE {
        USB, /**< USB input mode  */
        GMSL, /** < GMSL input mode (only on NVIDIA Jetson) */
        AUTO, /** < Automatically select the input type (trying first for availabled USB cameras, then GMSL) */
        ///@cond SHOWHIDDEN 
        LAST
        ///@endcond
    };
    ...
    public:
        ...
        \note the following notes are only available for v2.8.5 and up. Previously, the internal port used to receive stream was randomly chosen between a list of available ports.
    ...
    \brief List available models for object detection module
     */
    ...
    \ingroup Body_group
    \brief List available models for body tracking module
     */
    ...
    enum class AI_MODELS {
        MULTI_CLASS_DETECTION, // related to sl::DETECTION_MODEL::MULTI_CLASS_BOX
        MULTI_CLASS_MEDIUM_DETECTION, // related to sl::DETECTION_MODEL::MULTI_CLASS_BOX_MEDIUM
        MULTI_CLASS_ACCURATE_DETECTION, // related to sl::DETECTION_MODEL::MULTI_CLASS_BOX_ACCURATE
        HUMAN_BODY_FAST_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        HUMAN_BODY_MEDIUM_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_MEDIUM
        HUMAN_BODY_ACCURATE_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_ACCURATE
        HUMAN_BODY_38_FAST_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        HUMAN_BODY_38_MEDIUM_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        HUMAN_BODY_38_ACCURATE_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        HUMAN_BODY_70_FAST_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        HUMAN_BODY_70_MEDIUM_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        HUMAN_BODY_70_ACCURATE_DETECTION, // related to sl::DETECTION_MODEL::HUMAN_BODY_FAST
        PERSON_HEAD_DETECTION, // related to sl::DETECTION_MODEL::PERSON_HEAD_BOX
        PERSON_HEAD_ACCURATE_DETECTION, // related to sl::DETECTION_MODEL::PERSON_HEAD_BOX_ACCURATE
    ...
    struct AI_Model_status {
        ...
        bool optimized; // an engine file with the expected architecture is found.
    };
    ...
    /**
    \ingroup Core_group
    \brief \ref Timestamp representation and utilities.
     */
    struct Timestamp {
        /**
        ...
        /**
        \brief Init. the Timestamp to a number in nanoseconds.
         */
...
#undef GPU
    ...
    public:
        ...
        \param stream : specifies the GPU stream to be used to enable Asynchronous overlaping (default 0 is synchronous).
    ...
    struct CameraConfiguration {
        ...
        CalibrationParameters calibration_parameters_raw; /**< Intrinsic and Extrinsic stereo parameters for original images (unrectified/distorded). The returned parameters might vary between two execution due to the \ref InitParameters.camera_disable_self_calib "self-calibration" being ran in the \ref open() method. */
   ...
   \brief Available object subclass, given as hint, when using object tracking an object can change of OBJECT_SUBCLASS while keeping the same OBJECT_CLASS and id (i.e: frame M: MOTORBIKE, frame N:BICYCLE)
    ...
    enum class BODY_FORMAT {
        /**
         * \brief 18 keypoints model. 
         * Basic Body model
         */
        BODY_18,

        /**
         * \brief 34 keypoints model. 
         * Body model, requires body fitting enabled
         */
        BODY_34,

        /**
         * \brief 38 keypoints model.
    ...
    public:
        ...
        /**
        \brief Object label, forwarded from \ref CustomBoxObjectData when using \ref OBJECT_DETECTION_MODEL::CUSTOM_BOX_OBJECTS
         */
        int raw_label = 0;
    ...
    public:
         ...
         * Should define an object class. This means that any similar object (in classification) should share the same label number.
         */
        int label;
    ...
    public:
        ...
        /**
        \brief Function that looks for a given object ID in the current object list and returns the object associated if found and a status
    ...
    /**
   \ingroup Body_group
   \brief Contains data of a detected body such as its \ref bounding_box, \ref label, \ref id and its 3D \ref position.
     */
    ...
    public:
        ...
        /**
        \brief Defines the detection confidence value of the object. 
         * From 0 to 100, a low value means the object might not be localized perfectly.
         */
        float confidence;
        ...
        /**
           ...
           \warning Not available with sl::BODY_FORMAT::POSE_18.
         */
    ...
    /**
   \ingroup Body_group
   \brief Contains the result of the body tracking module.
   The detected bodies are listed in \ref body_list.
     */
    ...
    public:
        ...
        /**
        \brief Status of the actual inference precision mode used to detect the Bodies. It depends on the GPU hardware support, 
         * the BodyTrackingParameters::allow_reduced_precision_inference input parameter and the model support
         */
        sl::INFERENCE_PRECISION inference_precision_mode;
        
        /**
        \brief Defined the body format, set from BodyTrackingParameters::body_format parameter
         */
    ...
    /**
     * \ingroup Body_group
     * \brief semantic of human body parts and order of \ref BodyData::keypoint for BODY_FORMAT::BODY_18.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief semantic of human body parts and order of \ref BodyData::keypoint for BODY_FORMAT::BODY_34.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief semantic of human body parts and order of \ref BodyData::keypoint for BODY_FORMAT::BODY_38.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief semantic of human body parts and order of \ref BodyData::keypoint for BODY_FORMAT::BODY_70.
     */
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const sl::BODY_70_PARTS &body_part);

    inline std::ostream &operator<<(std::ostream &os, const sl::BODY_70_PARTS &body_part) {
        return os << toString(body_part);
    }

    /**
     * \ingroup Body_group
     * \brief return associated index of each \ref BODY_18_PARTS
     */
    ...
    /**
     * \ingroup Body_group
     * \brief return associated index of each \ref BODY_34_PARTS
     */
    ...
    /**
     * \ingroup Body_group
     * \brief return associated index of each \ref BODY_38_PARTS
     */
    ...
    /**
     * \ingroup Body_group
     * \brief return associated index of each \ref BODY_70_PARTS
     */
    inline int getIdx(BODY_70_PARTS part) {
        return static_cast<int> (part);
    }

    /**
   \ingroup Body_group
     * \brief Links of human body keypoints for BODY_FORMAT::BODY_18, useful for display.
     */
    ...
    /**
    \ingroup Body_group
     * \brief Links of human body keypoints for BODY_FORMAT::BODY_34, useful for display.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Links of human body keypoints for BODY_FORMAT::BODY_38, useful for display.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Links of human body keypoints for BODY_FORMAT::BODY_70, useful for display.
     */
    ...
    /**
    \ingroup Body_group
    \brief Contains batched data of a detected bodies
     */
    ...
    public:
        ...
        \enum COMM_TYPE
        \ingroup Fusion_group
        \brief Lists the types of communications available for Fusion app.
         */
        enum class COMM_TYPE {
            LOCAL_NETWORK, /* the sender and receiver are on the same local network and communicate by RTP, communication can be affected by the network load.*/
            INTRA_PROCESS, /* both sender and receiver are declared by the same process, can be in different threads, this communication is optimized.*/
            ///@cond SHOWHIDDEN 
            LAST
            ///@endcond
        };
...
#define ZED_SDK_BUILD_ID "70450_a7a3d754"
...
#define isValidMeasure(v) (std::isfinite(v))
    ...
    enum class RESOLUTION {
        ...
        AUTO, /**< Select the resolution compatible with camera, on ZEDX HD1200, HD720 otherwise */
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
    ...
    enum class VIDEO_SETTINGS {
        ...
        EXPOSURE_TIME, /**< Defines the real exposure time in microseconds. \note Only available for ZED X cameras, replace EXPOSURE setting.*/
        ANALOG_GAIN,/**< Defines the real analog gain (sensor) in mDB. Range is defined by Jetson DTS and by default [1000-16000]. \note Only available for ZED X cameras, replace GAIN settings.*/
        DIGITAL_GAIN,/**< Defines the real digital gain (ISP) as a factor. Range is defined by Jetson DTS and by default [1-256]. \note Only available for ZED X cameras, replace GAIN settings.*/
        AUTO_EXPOSURE_TIME_RANGE, /**< Defines the range of exposure auto control in micro seconds.Used with \ref setCameraSettings(VIDEO_SETTINGS,int,int).  Min/Max range between Max range defined in DTS. By default : [28000 - <fps_time> or 19000] us. \note Only available for ZED X cameras.*/
        AUTO_ANALOG_GAIN_RANGE, /**< Defines the range of sensor gain in automatic control. Used with \ref setCameraSettings(VIDEO_SETTINGS,int,int). Min/Max range between Max range defined in DTS. By default : [1000 - 16000] mdB. \note Only available for ZED X cameras.*/
        AUTO_DIGITAL_GAIN_RANGE, /**< Defines the range of digital ISP gain in automatic control. Used with \ref setCameraSettings(VIDEO_SETTINGS,int,int). Min/Max range between Max range defined in DTS. By default : [1 - 256]. \note Only available for ZED X cameras.*/
        EXPOSURE_COMPENSATION, /**< Defines the Exposure-target compensation made after auto exposure. Reduces the overall illumination target by factor of F-stops. values range is [0 - 100] (mapped between [-2.0,2.0]). Default value is 50, i.e. no compensation applied. \note Only available for ZED X cameras.*/
        DENOISING, /**< Defines the level of denoising applied on both left and right images. values range is [0-100]. Default value is 50. \note Only available for ZED X cameras.*/
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
    ...
    enum class VIEW {
        ...
        DEPTH, /**< Color rendering of the depth. Each pixel contains 4 unsigned char (B,G,R,A). sl::MAT_TYPE::U8_C4. Use \ref MEASURE "MEASURE::DEPTH" with \ref Camera.retrieveMeasure() to get depth values.*/
    ...
    enum class SVO_COMPRESSION_MODE {
        ...
        H264_LOSSLESS, /**< H264 Lossless GPU/Hardware based compression: avg size = 25% (of RAW). Provides a SSIM/PSNR result (vs RAW) >= 99.9%. Requires a NVIDIA GPU */
        H265_LOSSLESS, /**< H265 Lossless GPU/Hardware based compression: avg size = 25% (of RAW). Provides a SSIM/PSNR result (vs RAW) >= 99.9%. Requires a NVIDIA GPU */
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
...
namespace sl {
    ...
    \endcode
    With its default values, it opens the ZED camera in live mode at \ref RESOLUTION "RESOLUTION::HD720" and sets the depth mode to \ref DEPTH_MODE "DEPTH_MODE::ULTRA" ( \ref DEPTH_MODE "DEPTH_MODE::PERFORMANCE" on Jetson).\n
    ...
    public:
        ...
        \n This parameter controls a stabilization filter that reduces these oscillations. In the range [0-100], 0 is disable (raw depth), smoothness is linear from 1 to 100.
        \n default : 1
    ...
    public:
         ...
         * if any steady objects are in front of the camera and may perturbed the positional tracking algorithm.
    ...
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ObjectDetectionParameters {
       ...
       \brief Defines a upper depth range for detections.
         ...
         * \n Default value is set to \ref OBJECT_FILTERING_MODE::NMS_3D to keep the same behavior as previous SDK version
         * \note : This parameter is only used in Detection Model MULTI_CLASS_BOX_XXXX and CUSTOM_BOX_OBJECTS
         * \note : For Custom Object mode, it is recommended to use OBJECT_FILTERING_MODE::NMS_3D_PER_CLASS or OBJECT_FILTERING_MODE::NONE. In this case, you might need to
         * add your own NMS filter before ingesting the boxes into the object detection module.
         */
    ...
    \ingroup Body_group
    \brief Sets the body tracking parameters.
    ...
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/BodyTrackingParameters {
        ...
        /**
         * \brief Defines the body format outputted by the sdk when \ref retrieveBodies is called.
         */
    ...
    public:
        ...
        \brief This function only works with the following VIDEO_SETTINGS :
        \ref sl::VIDEO_SETTINGS::AUTO_EXPOSURE_TIME_RANGE
        \ref sl::VIDEO_SETTINGS::AUTO_ANALOG_GAIN_RANGE
        \ref sl::VIDEO_SETTINGS::AUTO_DIGITAL_GAIN_RANGE
        Possible values (range) of each setting are available \ref VIDEO_SETTINGS "here".
        ...
        int aec_range_min = 0;
        int aec_range_max = 0;
        sl::ERRROR_CODE err = zed.getCameraSettings(VIDEO_SETTINGS::AUTO_EXPOSURE_TIME_RANGE,aec_range_min,aec_range_max);
        ...
        \return ERROR_CODE to indicate if the function was successfull. If successfull, min_val/max_val will be filled with the corresponding values.
         */
        ...
        \return ERROR_CODE to indicate if the function was successfull. If successfull, roi will be filled with the corresponding values.
         */
        ...
        This function only applies for VIDEO_SETTINGS that require a single value.
        ...
        \return ERROR_CODE to indicate if the function was successfull.
         */
        ERROR_CODE setCameraSettings(VIDEO_SETTINGS settings, int value = VIDEO_SETTINGS_VALUE_AUTO);

        /**
        \brief Sets the value of the requested \ref VIDEO_SETTINGS "camera setting". (AEC_RANGE, ASGC_RANGE,ADGC_RANGE )
        This function only applies for VIDEO_SETTINGS that require a min/max value.
        Possible values (range) of each setting are available \ref VIDEO_SETTINGS "here".

        \param settings : the setting to be set.
        \param min : minimum value that can be reached (-1 or 0 gives full range)
        \param max : maximum value that can be reached (-1 or 0 gives full range)

        \code
        //For ZED-X based product, set the automatic exposure from 2ms to 5ms. Expected exposure time cannot go beyond those values
        zed.setCameraSettings(VIDEO_SETTINGS::AEC_RANGE,2000,5000);
        \endcode

        \note Works only if the camera is open in LIVE (USB or GMSL) or STREAM mode.
        \return ERROR_CODE to indicate if the function was successfull. If \ref VIDEO_SETTINGS settings is not supported or min>=max, it will return ERROR_CODE::INVALID_FUNCTION_PARAMETERS
         */
        ...
        \param setting : must be set at a valid \ref VIDEO_SETTINGS that acccepts a min/max range and available for the current ZED Model
        \return ERROR_CODE to indicate if the function was successfull.
         */
        ...
        \param roi_mask: the \ref Mat defining the requested region of interest, all pixel set to 0 will be discard. If empty, set all pixels as valid, otherwise should fit the resolution of the current instance and its type should be U8_C1.
        ...
        \return \ref ERROR_CODE::SUCCESS if values can be extracted, \ref ERROR_CODE::FAILURE otherwise
         */
        ...
        \note This function is asynchronous because the generated data can be heavy, be sure to loop over the  \ref getAreaExportState() function with a waiting time.
        ...
        \n The \ref getAreaExportState() function will return \ref AREA_EXPORTING_STATE "AREA_EXPORTING_STATE::FILE_EMPTY".
        ...
        <p>Time-fused pose estimation that can be accessed using:</p>
        <ul><li>\ref data.imu.pose</li></ul>
        <p>Raw values from the IMU sensor:</p>
        ...
        \n both gyroscope and accelerometer are synchronized. The delta time between previous and current value can be calculated using \ref data.imu.timestamp.
        ...
        \return \ref ERROR_CODE::SENSORS_NOT_AVAILABLE if the camera model is a ZED.
        \return \ref ERROR_CODE::MOTION_SENSORS_REQUIRED if the camera model is correct but the sensors module is not opened.
        \return \ref ERROR_CODE::INVALID_FUNCTION_PARAMETERS if the reference_time is not valid. See Warning.
        ...
        \n The object detection module currently supports :
        ...
        \return  \ref ERROR_CODE::INVALID_FUNCTION_CALL if batching module is not available or if object tracking was not enabled.
        \code
        Objects objects; // Unique Objects to be updated after each grab
        // --- Main loop
        while (true) {
        ...
        Detected objects can be retrieved using the \ref retrieveBodies() function.
        ...
        - <b>Synchronous:</b> the \ref retrieveBodies() function will be blocking during the detection.
        ...
        int main(int argc, char **argv) {
            ...
            // Set the object detection parameters
            BodyTrackingParameters object_detection_params;
            skeleton_params.image_sync = true;

            // Enable the object detection
            err = zed.enableBodyTracking(object_detection_params);
            if (err != SUCCESS) {
                std::cout << toString(err) << std::endl;
                exit(-1);
            }
        ...
        \endcode
         */
        ERROR_CODE enableBodyTracking(BodyTrackingParameters object_detection_parameters = BodyTrackingParameters());
        ...
        /**
        \brief Disables the Body Detection process.
        ...
        \code
        Bodies objects; // Unique Bodies to be updated after each grab
        // --- Main loop
        while (true) {
            if (zed.grab() == SUCCESS) { // Grab an image from the camera
                zed.retrieveBodies(objects);
         ...
         *
         */
        ERROR_CODE retrieveBodies(Bodies &objects, BodyTrackingRuntimeParameters parameters = BodyTrackingRuntimeParameters(), unsigned int instance_id = 0);
        ...
        /**
        \brief Returns the object detection parameters used. Correspond to the structure send when the \ref enableBodyTracking() function was called.
        ...
        \note If you use it, you should inclue 'sl/Fusion.hpp' to avoid undefined reference.
        \return \ref SUCCESS if everything went fine, \ref ERROR_CODE::FAILURE otherwise
         */
        ...
        /**
        \ingroup Fusion_group
        \brief Returns the communication parameter of this camera.
        \return \ref The CommunicationParameters used to comminucated with the Fusion Module.
         */
